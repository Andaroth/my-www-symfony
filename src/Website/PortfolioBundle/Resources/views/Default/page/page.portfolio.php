...
<main>
  ...
  <section id="screensmatrix" class="screensmatrix fullh">
    ...
    <div id="webslide" class="webslide center slider">
      ...
      <div class="tile-slide">
        <a href="https://agenceduweb.be/" class="tile">
         <div class="description">
            <h3>l'Agence Du Web</h3>
            <p>The Web Agency I co-founded with associates. This website is made with WordPress, one of my specialties. </p>
          </div>
          <img src="<?= IMG ?>mini/agencedu.png" alt="l'Agence Du Web" />
        </a>
      </div>
      <div class="tile-slide">
      ...
      <div class="tile-slide">
        <a href="../learning/curiculum" class="tile">
          <div class="description">
            <h3>My online CV</h3>
            <p>A little exercice I made at BeCode in HTML and CSS, it was really relaxing.</p>
          </div>
  ...
  <section id="animhearted" class="animhearted">
    ...
    <article>
      <header>
        <h3>Kultura Nivelles</h3>
      </header>
      <iframe src="https://www.youtube.com/embed/nwYyM39vSX8" allowfullscreen></iframe>
      <footer>
        <p>Performing street artists from KulturaNivl at Idem Paper.</p>
      </footer>
    </article>
    <article>
      <header>
    ...
    <a href="./" class="btn shadebtn">Return to the homepage</a>
  </section>
</main>
